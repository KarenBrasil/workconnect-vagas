...
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var email, password, userCredential, error_1, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    email = "ass.karenm@gmail.com";
                ...
                case 3:
                    error_1 = _a.sent();
                    console.log("Erro ao criar (talvez já exista):", error_1.code);
                    if (!(error_1.code === 'auth/email-already-in-use')) return [3 /*break*/, 8];
                ...
                case 6:
                    e_1 = _a.sent();
                    console.log("Falha ao logar. A senha não é admin123456.", e_1.code);
                    return [3 /*break*/, 7];
                case 7: return [3 /*break*/, 9];
                case 8:
                    console.log("Outro erro:", error_1);
                    _a.label = 9;
